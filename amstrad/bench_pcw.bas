...
1140 next i
1150 p=p+1
1160 if peek(64504)<=20 then goto 1120
...
1340 next i
1350 f=f+1
1360 if peek(64504)<=20 then goto 1320
...
1560 next i
1570 s=s+1
1580 if peek(64504)<=20 then goto 1520
...
1740 next i
1750 l=l+1
1760 if peek(64504)<=20 then goto 1720
...
1860 next i
1870 g=g+1
1880 if peek(64504)<=20 then goto 1840
1890 goto 1910
1900 return
1910 :
...
2040 next i
2050 a=a+1
2060 if peek(64504)<=20 then goto 2020
...
2270 next i
2280 m=m+1
2290 if peek(64504)<=20 then goto 2240
